...
#<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    def _validate_new_iosapp_data(self, Device):
        ...
        #if Device.DeviceFmZoneNextToUpdate is None:
        #    Device.DeviceFmZoneNextToUpdate = Device.DeviceFmZoneHome
...
#----------------------------------------------------------------------------
    def _determine_interval_and_next_update(self, Device):
        ...
        try:
            ...
            # statzone.move_noniosapp_devices_out_of_device_zone(Device)
