...
const TextController_1 = __importDefault(require("./TextController"));
const TextOutputController_1 = __importDefault(require("./TextOutputController"));
exports.inputs = {
    value: {
