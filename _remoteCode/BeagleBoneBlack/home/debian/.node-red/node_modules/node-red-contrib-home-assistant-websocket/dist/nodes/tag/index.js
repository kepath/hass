...
function tagNode(config) {
    ...
    const controller = new TagController_1.default({
        node: this,
        status,
        ...controllerDeps,
    });
    controller.setExposeAsConfigNode(exposeAsConfigNode);
    clientEvents.addListener(`ha_events:${homeAssistant_1.HaEvent.TagScanned}`, controller.onTagScanned.bind(controller));
}
