...
exports.default = timeEntityNode;
...
const TextOutputController_1 = __importDefault(require("../text/TextOutputController"));
const TimeEntityController_1 = __importDefault(require("./TimeEntityController"));
exports.inputs = {
    value: {
...
function timeEntityNode(config) {
    ...
    switch (this.config.mode) {
        ...
        case const_1.ValueIntegrationMode.Set:
            {
                ...
                new TimeEntityController_1.default({
                    inputService,
        ...
        case const_1.ValueIntegrationMode.Listen: {
            ...
            const controller = new TextOutputController_1.default({
                node: this,
                ...controllerDeps,
            });
