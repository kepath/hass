...
class Websocket {
    ...
    onClientOpen() {
        ...
        if (__classPrivateFieldGet(this, _Websocket_config, "f").heartbeatInterval) {
            __classPrivateFieldGet(this, _Websocket_instances, "m", _Websocket_stopAssignedHeartbeat).call(this);
...
}, _Websocket_stopAssignedHeartbeat = function _Websocket_stopAssignedHeartbeat() {
    if (typeof __classPrivateFieldGet(this, _Websocket_stopHeartbeat, "f") === 'function') {
        const stopHeartbeat = __classPrivateFieldGet(this, _Websocket_stopHeartbeat, "f");
        __classPrivateFieldSet(this, _Websocket_stopHeartbeat, undefined, "f");
        stopHeartbeat();
    }
};
