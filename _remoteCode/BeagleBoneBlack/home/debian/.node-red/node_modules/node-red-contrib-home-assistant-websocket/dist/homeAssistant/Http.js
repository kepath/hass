...
const HomeAssistantError_1 = __importDefault(require("../common/errors/HomeAssistantError"));
...
class Http {
    ...
    async getHistory(timestamp, filterEntityId, endTimestamp, flatten = false) {
    ...
    async post(path, data = {}, responseType = 'json') {
        ...
        const response = await __classPrivateFieldGet(this, _Http_client, "f")
            ...
            if ((_b = (_a = err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) {
                throw new HomeAssistantError_1.default(err.response.data);
            }
            throw err;
        });
    ...
    async put(path, data = {}, responseType = 'json') {
        var _a;
        debug(`HTTP PUT: ${__classPrivateFieldGet(this, _Http_client, "f").defaults.baseURL}/${path}`);
        const response = await __classPrivateFieldGet(this, _Http_client, "f")
            .request({
            method: 'put',
            url: path,
    ...
    async delete(path, data = {}, responseType = 'json') {
        var _a;
        debug(`HTTP DELETE: ${__classPrivateFieldGet(this, _Http_client, "f").defaults.baseURL}/${path}`);
        const response = await __classPrivateFieldGet(this, _Http_client, "f")
            .request({
            method: 'delete',
            url: path,
