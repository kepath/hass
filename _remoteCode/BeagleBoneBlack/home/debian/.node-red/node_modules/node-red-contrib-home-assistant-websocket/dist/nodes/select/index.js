...
const SelectOutputController_1 = __importDefault(require("./SelectOutputController"));
exports.inputs = {
    value: {
        ...
        case const_1.ValueIntegrationMode.Set:
            {
                ...
                new SelectController_1.default({
                    inputService,
        ...
        case const_1.ValueIntegrationMode.Listen:
            {
                ...
                const controller = new SelectOutputController_1.default({
                    node: this,
                    ...controllerDeps,
                });
