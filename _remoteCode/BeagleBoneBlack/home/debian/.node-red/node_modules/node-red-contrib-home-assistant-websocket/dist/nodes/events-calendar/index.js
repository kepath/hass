...
exports.default = eventsCalendarNode;
...
const EventsCalendarController_1 = __importDefault(require("./EventsCalendarController"));
function eventsCalendarNode(config) {
    ...
    const controller = new EventsCalendarController_1.default({
        node: this,
        status,
        ...controllerDeps,
    });
