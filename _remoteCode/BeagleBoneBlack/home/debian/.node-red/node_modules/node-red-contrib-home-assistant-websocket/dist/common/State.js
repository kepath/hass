...
class State {
    constructor(node) {
        ...
        __classPrivateFieldSet(this, _State_enabled, (_a = StorageService_1.default.getNodeData(node.id, 'isEnabled')) !== null && _a !== void 0 ? _a : true, "f");
        __classPrivateFieldSet(this, _State_lastPayload, StorageService_1.default.getNodeData(node.id, 'lastPayload'), "f");
    ...
    async setEnabled(state) {
        ...
        await StorageService_1.default
            .saveNodeData(__classPrivateFieldGet(this, _State_node, "f").id, 'isEnabled', state)
            .catch(__classPrivateFieldGet(this, _State_node, "f").error);
    ...
    async setLastPayload(payload) {
        ...
        await StorageService_1.default
            .saveNodeData(__classPrivateFieldGet(this, _State_node, "f").id, 'lastPayload', payload)
            .catch(__classPrivateFieldGet(this, _State_node, "f").error);
        __classPrivateFieldGet(this, _State_instances, "m", _State_emitChange).call(this);
    }
    getLastPayload() {
...
_State_enabled = new WeakMap(), _State_lastPayload = new WeakMap(), _State_node = new WeakMap(), _State_instances = new WeakSet(), _State_onClose = async function _State_onClose(removed, done) {
    if (removed) {
        await StorageService_1.default.removeNodeData(__classPrivateFieldGet(this, _State_node, "f").id).catch(done);
    }
    done();
