...
exports.isEventsCalendarNodeProperties = isEventsCalendarNodeProperties;
...
function isEventsCalendarNodeProperties(node) {
    return node.type === const_1.NodeType.EventsCalendar;
}
