...
exports.isCurrentStateNodeProperties = isCurrentStateNodeProperties;
...
function issueCheck(config) {
    const issues = [];
    const invalidIds = (0, check_1.getInvalidIds)(IssueService_1.IssueType.StateId, config, config.entity_id);
...
function isCurrentStateNodeProperties(node) {
    return node.type === const_1.NodeType.CurrentState;
}
