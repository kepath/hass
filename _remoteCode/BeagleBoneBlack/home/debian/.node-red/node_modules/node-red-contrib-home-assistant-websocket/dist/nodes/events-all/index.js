...
exports.HA_CLIENT = void 0;
exports.default = eventsAllNode;
...
const EventsAllController_1 = __importDefault(require("./EventsAllController"));
const validate_1 = require("./validate");
exports.HA_CLIENT = 'home_assistant_client';
function eventsAllNode(config) {
    globals_1.RED.nodes.createNode(this, config);
    this.config = (0, migrate_1.migrate)(config);
    (0, validate_1.validateConfig)(this.config);
    ...
    const controller = new EventsAllController_1.default({
        node: this,
        status,
        ...controllerDeps,
    });
    controller.setExposeAsConfigNode(exposeAsConfigNode);
    (0, events_1.startListeners)(clientEvents, controller, homeAssistant, this);
}
