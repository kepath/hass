...
`,tr=(e,t,r=!1,a=!0)=>{const i=t.color??"disabled",n=(e=>Boolean(e&&Array.isArray(e)))(e)?e:[e??"background"],o={},s=(e=>["primary","accent"].includes(e)?`var(--rgb-${e}-color)`:`var(--rgb-${e})`)(i),l=n.includes("background")&&(!r&&"black"===i||r&&"white"===i),c="black"===i?"rgba(255, 255, 255, .7)":"rgba(0, 0, 0, .7)";return n.includes("icon")&&(o["--trash-card-icon-color"]=`rgba(${s})`),n.includes("background")&&(o["--trash-card-background"]=`rgba(${s}, .7)`),l&&(o["--text-color"]=c,o["--card-primary-color"]=c,o["--card-secondary-color"]=c,o["--primary-text-color"]=c),l&&a&&(o["--trash-card-icon-color"]=c),o},rr=De(class extends Ee{constructor(e){var t;if(super(e),e.type!==xe||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){var r,a;if(void 0===this.it){this.it=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!(null===(r=this.nt)||void 0===r?void 0:r.has(e))&&this.it.add(e);return this.render(t)}const i=e.element.classList;this.it.forEach((e=>{e in t||(i.remove(e),this.it.delete(e))}));for(const e in t){const r=!!t[e];r===this.it.has(e)||(null===(a=this.nt)||void 0===a?void 0:a.has(e))||(r?(i.add(e),this.it.add(e)):(i.remove(e),this.it.delete(e)))}return Y}});let ar=class extends oe{render(){if(!this.item||!this.config)return H;const e=this.item.icon??"mdi:delete-outline";return L`<ha-state-icon
        .hass=${this.hass}
        .icon=${e}
      ...
      `]}};t([he()],ar.prototype,"item",void 0),t([he()],ar.prototype,"hass",void 0),t([he()],ar.prototype,"config",void 0),ar=t([le(`${pe}-element-icon`)],ar);let ir=class extends oe{render(){return this.pictureUrl?L`<img
    src="${this.pictureUrl}" slot=${this.slot?this.slot:void 0}/>`:H}static get styles(){return[l`
      ...
      `]}};t([he()],ir.prototype,"item",void 0),t([he()],ir.prototype,"hass",void 0),t([he()],ir.prototype,"config",void 0),t([he()],ir.prototype,"pictureUrl",void 0),ir=t([le(`${pe}-element-picture`)],ir);class nr extends oe{constructor(){super(...arguments),this.withBackground=!1}getPictureUrl(){return e=this.item.picture,t=this.hass,e?`${t.hassUrl(e)}`:void 0;var e,t;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}getWithBackgroundClass(){return{withBackground:Boolean(this.withBackground)}}renderPicture(e){const t={...this.getWithBackgroundClass()};return L`
      ...
      `]}}t([he()],nr.prototype,"item",void 0),t([he()],nr.prototype,"hass",void 0),t([he()],nr.prototype,"config",void 0);let or=class extends nr{render(){if(!this.hass||!this.item||!this.config)return H;const e=this.item,t=it(this.hass),{color_mode:r,hide_time_range:a,day_style:i,layout:n,with_label:o,day_style_format:s}=this.config,{label:l}=e,c={...tr(r,e,this.hass.themes.darkMode)},d=qt(e,a??!1,i,s,this.hass),u=Wt(new Date,e),h={today:0===u,tomorrow:1===u,another:u>1},m=this.getPictureUrl();return this.withBackground=!0,L`
      <ha-card style=${Ce(c)} class=${rr(h)}>
    ...
    `}static get styles(){return[er,...nr.styles,l`
        ha-card {
      ...
      `]}};t([he()],sr.prototype,"items",void 0),t([ue({attribute:!1})],sr.prototype,"hass",void 0),t([he()],sr.prototype,"config",void 0),sr=t([le(`${pe}-cards-container`)],sr);let lr=class extends nr{render(){if(!this.hass||!this.item||!this.config)return H;const e=this.item,t=it(this.hass),{color_mode:r,hide_time_range:a,day_style:i,day_style_format:n,with_label:o}=this.config,s={...tr(r,e,this.hass.themes.darkMode),...o?{"--chip-height":"calc(36px * 1.15)"}:{}},l=qt(e,a??!1,i,n,this.hass),c=Wt(new Date,e),d={today:0===c,tomorrow:1===c,another:c>1},u=this.getPictureUrl();return this.withBackground=!0,L`
      <mushroom-chip
        style=${Ce(s)}
        class=${rr(d)}
        ?rtl=${t}
      ...
      </mushroom-chip>`}static get styles(){return[...nr.styles,l`
        mushroom-chip {
  ...
  `}static get styles(){return[er,l`
      ...
      `]}};t([he()],cr.prototype,"items",void 0),t([ue({attribute:!1})],cr.prototype,"hass",void 0),t([he()],cr.prototype,"config",void 0),cr=t([le(`${pe}-chips-container`)],cr);let dr=class extends nr{render(){if(!this.hass||!this.item||!this.config)return H;const e=this.item,t=it(this.hass),r={...tr(["icon","background"],e,this.hass.themes.darkMode,!1),"--trash-card-icon-size":`${this.config.icon_size??40}px`},a=Wt(new Date,e),i={today:0===a,tomorrow:1===a,another:a>1,nextEvent:this.item.nextEvent,futureEvent:!this.item.nextEvent},n=this.getPictureUrl();return this.withBackground=!0,L`
      <ha-card style=${Ce(r)} class=${rr(i)}>
    ...
    `}static get styles(){return[er,...nr.styles,l`
      ...
      `]}};t([he()],ur.prototype,"items",void 0),t([ue({attribute:!1})],ur.prototype,"hass",void 0),t([he()],ur.prototype,"config",void 0),ur=t([le(`${pe}-icons-container`)],ur);let hr=class extends oe{render(){return L`
          <div class="title">
      ...
      `]}};hr=t([le(`${pe}-title`)],hr);let mr=class extends oe{render(){if(!this.item)return H;const{message:e,data:t}=this.item;return L`
      ...
      `]}};t([he()],mr.prototype,"item",void 0),mr=t([le(`${pe}-logrow`)],mr);let pr=class extends oe{copyDebugLogToClipboard(e){e.stopPropagation(),navigator.clipboard.writeText(JSON.stringify(this.debugger?.getLogs()??{})).then((()=>{alert("Debug data copied to clipboard")}))}render(){return this.debugger?L`<ha-card class="debug-container">
        <trash-card-title>
    ...
    </ha-card>`:H}static get styles(){return[er,l`
        .debug-container {
          margin-bottom: 5px;
          border: rgb(var(--rgb-pink)) dotted 1px;
          opacity: 0.7;
        }
      `]}};t([he()],pr.prototype,"debugger",void 0),pr=t([le(`${pe}-debug-container`)],pr),(t=>{const r=window;r.customCards=r.customCards||[],r.customCards.push({...t,preview:!0,documentationURL:`${e}/blob/main/README.md`})})({type:pe,name:"TrashCard",description:"TrashCard - indicates what type of trash will be picked up next based on your calendar entries 🗑️"});const gr={tap_action:{action:"more-info"},hold_action:{action:"more-info"},with_label:!0,debug:!1};let fr=class extends oe{constructor(){super(...arguments),this.startDate=new Date,this.endDate=new Date}static async getConfigElement(){return await Promise.resolve().then((function(){return Gr})),document.createElement(ge)}static async getStubConfig(e){const t=Object.keys(e.states);return{type:`custom:${pe}`,entities:[t[0]]}}get hass(){return this._hass}set hass(e){this._hass=e,this.shadowRoot?.querySelectorAll("div > *").forEach((t=>{t.setHass(e)}))}setConfig(e){this.config={...gr,...ze(e)?Ae(e):e},this.debugger=new fe}setDateRange(){this.startDate=new Date,this.endDate=new Date,this.endDate.setDate(this.endDate.getDate()+(this.config?.next_days??2)+1)}fetchCurrentTrashData(){if(!this.hass||!this.config||!this.debugger)return;this.setDateRange();const e=r(this.startDate),t=r(this.endDate),a=((e,t)=>{const[r,a,i]=t.split(":");return!(e.getHours()<Number(r))&&(e.getHours()>Number(r)||e.getMinutes()>Number(a)||e.getSeconds()>=Number(i))})(new Date,this.config.drop_todayevents_from??"10:00:00"),i=be();$e(this.hass,this.config.entities,{start:e,end:t,dropAfter:a},this.debugger,this.config,i).then((e=>{this.currentItems=e,this.lastChanged=new Date}))}getRefreshRate(){return 60*(this.config?.refresh_rate??60)*1e3}shouldUpdate(e){return!!e.has("currentItems")||(e.delete("currentItems"),(!this.lastChanged||e.has("config")||Date.now()-this.lastChanged.getTime()>this.getRefreshRate())&&this.fetchCurrentTrashData(),!1)}createBaseContainerElement(e){try{const t=`trash-card-${e??"card"}s-container`;if(customElements.get(t)){const e=document.createElement(t,this.config);return e.setConfig(this.config),e.setItems(this.currentItems),e}const r=document.createElement(t);return customElements.whenDefined(t).then((()=>{customElements.upgrade(r),r.setConfig(this.config),r.setItems(this.currentItems)})).catch((()=>{})),r}catch{return}}render(){if(!this.config||!this.hass)return H;if(!this.currentItems||0===this.currentItems.length)return this.config.debug?L`<trash-card-debug-container .debugger=${this.debugger}></trash-card-debug-card>`:H;const e=this.createBaseContainerElement(this.config.card_style);return e?(e.setHass(this.hass),L`
      ${this.config.debug?L`<trash-card-debug-container .debugger=${this.debugger}></trash-card-debug-card>`:""}
      ${e}`):H}};t([he()],fr.prototype,"_hass",void 0),t([he()],fr.prototype,"config",void 0),t([ue()],fr.prototype,"currentItems",void 0),t([ue()],fr.prototype,"startDate",void 0),t([ue()],fr.prototype,"endDate",void 0),t([ue()],fr.prototype,"debugger",void 0),fr=t([le(pe)],fr),console.info("%c🗑️ TrashCard 2.2.2","background-color: #ef5350; color: #ffffff");class yr extends TypeError{constructor(e,t){let r;const{message:a,explanation:i,...n}=e,{path:o}=e,s=0===o.length?a:`At path: ${o.join(".")} -- ${a}`;super(i??s),null!=i&&(this.cause=s),Object.assign(this,n),this.name=this.constructor.name,this.failures=()=>r??(r=[e,...t()])}}function vr(e){return"object"==typeof e&&null!=e}function _r(e){return"symbol"==typeof e?e.toString():"string"==typeof e?JSON.stringify(e):`${e}`}function br(e,t,r,a){if(!0===e)return;!1===e?e={}:"string"==typeof e&&(e={message:e});const{path:i,branch:n}=t,{type:o}=r,{refinement:s,message:l=`Expected a value of type \`${o}\`${s?` with refinement \`${s}\``:""}, but received: \`${_r(a)}\``}=e;return{value:a,type:o,refinement:s,key:i[i.length-1],path:i,branch:n,...e,message:l}}function*wr(e,t,r,a){(function(e){return vr(e)&&"function"==typeof e[Symbol.iterator]})(e)||(e=[e]);for(const i of e){const e=br(i,t,r,a);e&&(yield e)}}function*kr(e,t,r={}){const{path:a=[],branch:i=[e],coerce:n=!1,mask:o=!1}=r,s={path:a,branch:i};if(n&&(e=t.coercer(e,s),o&&"type"!==t.type&&vr(t.schema)&&vr(e)&&!Array.isArray(e)))for(const r in e)void 0===t.schema[r]&&delete e[r];let l="valid";for(const a of t.validator(e,s))a.explanation=r.message,l="not_valid",yield[a,void 0];for(let[c,d,u]of t.entries(e,s)){const t=kr(d,u,{path:void 0===c?a:[...a,c],branch:void 0===c?i:[...i,d],coerce:n,mask:o,message:r.message});for(const r of t)r[0]?(l=null!=r[0].refinement?"not_refined":"not_valid",yield[r[0],void 0]):n&&(d=r[1],void 0===c?e=d:e instanceof Map?e.set(c,d):e instanceof Set?e.add(d):vr(e)&&(void 0!==d||c in e)&&(e[c]=d))}if("not_valid"!==l)for(const a of t.refiner(e,s))a.explanation=r.message,l="not_refined",yield[a,void 0];"valid"===l&&(yield[void 0,e])}class $r{constructor(e){const{type:t,schema:r,validator:a,refiner:i,coercer:n=(e=>e),entries:o=function*(){}}=e;this.type=t,this.schema=r,this.entries=o,this.coercer=n,this.validator=a?(e,t)=>wr(a(e,t),t,this,e):()=>[],this.refiner=i?(e,t)=>wr(i(e,t),t,this,e):()=>[]}assert(e,t){return zr(e,this,t)}create(e,t){return function(e,t,r){const a=Ar(e,t,{coerce:!0,message:r});if(a[0])throw a[0];return a[1]}(e,this,t)}is(e){return function(e,t){const r=Ar(e,t);return!r[0]}(e,this)}mask(e,t){return function(e,t,r){const a=Ar(e,t,{coerce:!0,mask:!0,message:r});if(a[0])throw a[0];return a[1]}(e,this,t)}validate(e,t={}){return Ar(e,this,t)}}function zr(e,t,r){const a=Ar(e,t,{message:r});if(a[0])throw a[0]}function Ar(e,t,r={}){const a=kr(e,t,r),i=function(e){const{done:t,value:r}=e.next();return t?void 0:r}(a);if(i[0]){const e=new yr(i[0],(function*(){for(const e of a)e[0]&&(yield e[0])}));return[e,void 0]}return[void 0,i[1]]}function xr(e,t){return new $r({type:e,schema:null,validator:t})}function Dr(e){return new $r({type:"array",schema:e,*entries(t){if(e&&Array.isArray(t))for(const[r,a]of t.entries())yield[r,a,e]},coercer:e=>Array.isArray(e)?e.slice():e,validator:e=>Array.isArray(e)||`Expected an array value, but received: ${_r(e)}`})}function Er(){return xr("boolean",(e=>"boolean"==typeof e))}function Sr(){return xr("integer",(e=>"number"==typeof e&&!isNaN(e)&&Number.isInteger(e)||`Expected an integer, but received: ${_r(e)}`))}function Tr(e){const t=_r(e),r=typeof e;return new $r({type:"literal",schema:"string"===r||"number"===r||"boolean"===r?e:null,validator:r=>r===e||`Expected the literal \`${t}\`, but received: ${_r(r)}`})}function Cr(){return xr("number",(e=>"number"==typeof e&&!isNaN(e)||`Expected a number, but received: ${_r(e)}`))}function Mr(e){const t=e?Object.keys(e):[],r=xr("never",(()=>!1));return new $r({type:"object",schema:e||null,*entries(a){if(e&&vr(a)){const i=new Set(Object.keys(a));for(const r of t)i.delete(r),yield[r,a[r],e[r]];for(const e of i)yield[e,a[e],r]}},validator:e=>vr(e)||`Expected an object, but received: ${_r(e)}`,coercer:e=>vr(e)?{...e}:e})}function jr(e){return new $r({...e,validator:(t,r)=>void 0===t||e.validator(t,r),refiner:(t,r)=>void 0===t||e.refiner(t,r)})}function Rr(){return xr("string",(e=>"string"==typeof e||`Expected a string, but received: ${_r(e)}`))}function Ir(e){const t=e.map((e=>e.type)).join(" | ");return new $r({type:"union",schema:null,coercer(t){for(const r of e){const[e,a]=r.validate(t,{coerce:!0});if(!e)return a}return t},validator(r,a){const i=[];for(const t of e){const[...e]=kr(r,t,a),[n]=e;if(!n[0])return[];for(const[t]of e)t&&i.push(t)}return[`Expected the value to satisfy a union of \`${t}\`, but received: ${_r(r)}`,...i]}})}const Nr=e=>!!e&&e.themes.darkMode,Pr=Mr({index:jr(Cr()),view_index:jr(Cr()),view_layout:xr("any",(()=>!0)),type:Rr()}),Ur=["default","counter","custom"],Or=["card","chip","icon"],Lr=["left","center","right","space"],Yr=["background","icon"],Hr=function(...e){const t="type"===e[0].type,r=e.map((e=>e.schema)),a=Object.assign({},...r);return t?function(e){const t=Object.keys(e);return new $r({type:"type",schema:e,*entries(r){if(vr(r))for(const a of t)yield[a,r[a],e[a]]},validator:e=>vr(e)||`Expected an object, but received: ${_r(e)}`,coercer:e=>vr(e)?{...e}:e})}(a):Mr(a)}(Pr,Mr({entities:jr(Dr(Rr())),name:jr(Rr()),layout:jr(Ir([Tr("horizontal"),Tr("vertical"),Tr("default")])),fill_container:jr(Er()),filter_events:jr(Er()),full_size:jr(Er()),use_summary:jr(Er()),hide_time_range:jr(Er()),next_days:jr(Sr()),items_per_row:jr(Sr()),refresh_rate:jr(Sr()),drop_todayevents_from:jr(Rr()),event_grouping:jr(Er()),day_style:jr(Ir([Tr(Ur[0]),Tr(Ur[1]),Tr(Ur[2])])),day_style_format:jr(Rr()),card_style:jr(Ir([Tr(Or[0]),Tr(Or[1]),Tr(Or[2])])),alignment_style:jr(Ir([Tr(Lr[0]),Tr(Lr[1]),Tr(Lr[2]),Tr(Lr[3])])),color_mode:jr(Ir([Tr(Yr[0]),Tr(Yr[1])])),debug:jr(Er()),icon_size:jr(Sr()),with_label:jr(Er()),pattern:jr(Dr(Mr({color:jr(Rr()),icon:jr(Rr()),label:jr(Rr()),pattern:jr(Rr()),picture:jr(Rr()),type:Rr()})))})),Br=e=>[{name:"icon",label:e("ui.panel.lovelace.editor.card.generic.icon"),selector:{icon:{}},context:{icon_entity:"entity"}},{name:"color",label:e("ui.panel.lovelace.editor.card.tile.color"),selector:{ui_color:{}}}],Fr=(e,t,r)=>{const a=[{type:"grid",name:"",schema:[{name:"filter_events",label:e("editor.card.generic.filter_events"),selector:{boolean:{}}},{name:"drop_todayevents_from",label:e("editor.card.generic.drop_todayevents_from"),default:{hours:11,minutes:0,seconds:0},selector:{time:{}}},{name:"next_days",label:e("editor.card.generic.next_days"),selector:{number:{min:1,max:365,step:1,mode:"box"}}},{name:"refresh_rate",label:e("editor.form.refresh_rate.title"),helper:e("editor.form.refresh_rate.helper"),selector:{number:{min:5,max:1440,step:5,mode:"box"}}}]}],i=[{name:"card_style",label:e("editor.form.card_style.title"),selector:{select:{options:[...Or].map((t=>({value:t,label:e(`editor.form.card_style.values.${t}`)}))),mode:"dropdown"}}},{type:"grid",name:"",schema:[..."icon"===t.card_style?[{name:"icon_size",label:e("editor.card.generic.icon_size"),selector:{number:{min:10,max:160,step:1,mode:"box"}}}]:[],..."card"===t.card_style||"chip"===t.card_style?[{name:"day_style",label:e("editor.form.day_style.title"),selector:{select:{options:[...Ur].map((t=>({value:t,label:e(`editor.form.day_style.values.${t}`)}))),mode:"dropdown"}}}]:[],..."card"!==t.card_style&&"chip"!==t.card_style||"custom"!==t.day_style?[]:[{name:"day_style_format",label:e("editor.form.day_style_format.title"),helper:e("editor.form.day_style_format.helper"),selector:{text:{}}}],..."card"===t.card_style||"chip"===t.card_style?[{name:"hide_time_range",label:e("editor.card.generic.hide_time_range"),selector:{boolean:{}}}]:[],..."card"===t.card_style||"chip"===t.card_style?[{name:"with_label",label:e("editor.card.generic.with_label"),selector:{boolean:{}}}]:[],...!t.with_label||"card"!==t.card_style&&"chip"!==t.card_style?[]:[{name:"use_summary",label:e("editor.card.generic.use_summary"),selector:{boolean:{}}}],..."card"===t.card_style||"chip"===t.card_style?[{name:"event_grouping",label:e("editor.card.generic.event_grouping"),selector:{boolean:{default:!0}}}]:[],..."card"===t.card_style||"chip"===t.card_style?[{name:"color_mode",label:e("editor.form.color_mode.title"),selector:{select:{options:[...Yr].map((t=>({value:t,label:e(`editor.form.color_mode.values.${t}`)}))),mode:"dropdown"}}}]:[]]},..."card"===t.card_style?[{type:"grid",name:"",schema:[{name:"layout",label:e("editor.card.generic.layout"),selector:{mush_layout:{}}}]},{type:"grid",name:"",schema:[{name:"full_size",label:e("editor.card.generic.full_size"),selector:{boolean:{}}},{name:"items_per_row",label:r("ui.panel.lovelace.editor.card.grid.columns"),selector:{number:{min:1,max:6,step:1,mode:"box"}}}]}]:[],..."chip"===t.card_style?[{type:"grid",name:"",schema:[{name:"alignment_style",label:e("editor.form.alignment_style.title"),selector:{select:{options:[...Lr].map((t=>({value:t,label:e(`editor.form.alignment_style.values.${t}`)}))),mode:"dropdown"}}}]}]:[]];return[{name:"entities",selector:{entity:{domain:"calendar",multiple:!0}}},{type:"expandable",name:"",title:e("editor.form.tabs.settings"),icon:"mdi:cog",schema:a},{type:"expandable",name:"",title:e("editor.form.tabs.appearance"),icon:"mdi:palette",schema:i}]},Vr=(e,t,r,a)=>{a=a??{},r=r||{};const i=new Event(t,{bubbles:a.bubbles??!0,cancelable:Boolean(a.cancelable),composed:a.composed??!0});return i.detail=r,e.dispatchEvent(i),i},Zr={},Wr=De(class extends Ee{constructor(){super(...arguments),this.st=Zr}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.st)&&this.st.length===t.length&&t.every(((e,t)=>e===this.st[t])))return Y}else if(this.st===t)return Y;return this.st=Array.isArray(t)?Array.from(t):t,this.render(t,r)}});let Kr=class extends oe{constructor(){super(...arguments),this.attached=!1}connectedCallback(){super.connectedCallback(),this.attached=!0}disconnectedCallback(){super.disconnectedCallback(),this.attached=!1}updated(e){super.updated(e);const t=e.has("attached"),r=e.has("pattern");(r||t)&&r&&this.handleSettingsChanged()}async handleSettingsChanged(){await this.updateComplete}render(){if(!this.hass||!this.pattern)return H;const e=Zt(this.hass);return L`
      <div class="settings">
      ${Wr([this.pattern],(()=>this.pattern.map(((t,r)=>L`
          <div class="setting">
            <div class="icon">
    ...
    </div>`}editItem(e){const{index:t}=e.currentTarget;Vr(this,"edit-pattern-item",{subElementConfig:{index:t,key:t,elementConfig:this.pattern[t]}})}deleteItem(e){const{index:t}=e.currentTarget;Vr(this,"delete-pattern-item",{index:t})}createItem(e){const{index:t}=e.currentTarget;Vr(this,"create-pattern-item",{index:t})}static get styles(){return[l`
        .settings {
            display: grid;
        ...
        `]}};t([ue({attribute:!1})],Kr.prototype,"hass",void 0),t([he()],Kr.prototype,"pattern",void 0),t([he()],Kr.prototype,"attached",void 0),Kr=t([le("trash-card-pattern-editor")],Kr);const qr={event_grouping:!0,drop_todayevents_from:"10:00:00",next_days:2,pattern:[{icon:"mdi:flower",color:"lime",type:"organic"},{icon:"mdi:newspaper",color:"blue",type:"paper"},{icon:"mdi:recycle-variant",color:"amber",type:"recycle"},{icon:"mdi:trash-can-outline",color:"grey",type:"waste"},{icon:"mdi:dump-truck",color:"purple",type:"others"}],day_style:"default",day_style_format:"yyyy.MM.dd",card_style:"card",alignment_style:"left",color_mode:"background",items_per_row:1,refresh_rate:60,with_label:!0};let Jr=class extends oe{constructor(){super(...arguments),this.schema=Oe(Fr),this.computeLabel=e=>this.hass?e.label??"":e.label,this.computeHelper=e=>this.hass?e.helper??"":e.name}setConfig(e){ze(e)?Vr(this,"config-changed",{config:{...qr,...Ae(e)}}):(zr(e,Hr),this.config={...qr,...e})}updated(e){if(super.updated(e),e.has("hass")&&this.hass){const t=Nr(e.get("hass")),r=Nr(this.hass);t!==r&&this.toggleAttribute("dark-mode",r)}}renderFormPatternsEditor(){if(!this.hass)return H;const e=Zt(this.hass);if(this.subElementEditorConfig){const t="others"===this.subElementEditorConfig.elementConfig?.type?Br(this.hass.localize):((e,t)=>[{label:e("editor.card.trash.pattern.fields.label"),name:"label",selector:{text:{}}},...Br(t),{label:e("editor.card.trash.pattern.fields.pattern"),name:"pattern",selector:{text:{}}},{label:e("editor.card.trash.pattern.fields.picture_url"),helper:e("editor.card.trash.pattern.fields.picture_url_description"),name:"picture",selector:{text:{}},context:{icon_entity:"entity"}}])(e,this.hass.localize);return L`
      ...
      ></trash-card-pattern-editor>`}goBack(){this.subElementEditorConfig=void 0}handleSubElementChanged(e){if(e.stopPropagation(),!this.config||!this.hass||!this.subElementEditorConfig)return;const t=this.subElementEditorConfig.key,{value:r}=e.detail,a={...this.config,pattern:[...this.config.pattern??[]]};a.pattern[t]=r,this.subElementEditorConfig={...this.subElementEditorConfig,elementConfig:r},Vr(this,"config-changed",{config:a})}editPatternItem(e){this.subElementEditorConfig=e.detail.subElementConfig}createPatternItem(e){if(e.stopPropagation(),!this.config||!this.hass)return;const t=Zt(this.hass),r={...this.config,pattern:[...this.config.pattern??[]]},a=r.pattern.filter((e=>"custom"===e.type)).length+1;r.pattern.push({label:`${t("editor.card.trash.pattern.new_custom_label")} ${a}`,icon:"mdi:calendar",color:"pink",type:"custom"}),Vr(this,"config-changed",{config:r})}deletePatternItem(e){if(e.stopPropagation(),!this.config||!this.hass)return;const t={...this.config,pattern:[...this.config.pattern??[]]};t.pattern.splice(e.detail.index,1),Vr(this,"config-changed",{config:t})}render(){if(!this.hass||!this.config)return H;const e=Zt(this.hass),t=this.schema(e,this.config,this.hass.localize);return L`
      <ha-form
        .hass=${this.hass}
        .data=${this.config}
        .schema=${t}
    ...
    `}valueChanged(e){const t={...e.detail.value};"background"===t.color_mode&&delete t.color_mode,"default"===t.day_style&&delete t.day_style,"custom"!==t.day_style&&delete t.day_style_format,"card"===t.card_style&&delete t.card_style,Vr(this,"config-changed",{config:t})}static get styles(){return[l`
      ...
      `]}};t([ue({attribute:!1})],Jr.prototype,"hass",void 0),t([he()],Jr.prototype,"config",void 0),t([he()],Jr.prototype,"subElementEditorConfig",void 0),t([he()],Jr.prototype,"schema",void 0),Jr=t([le(ge)],Jr);var Gr=Object.freeze({__proto__:null,get TrashCardEditor(){return Jr}});export{fr as TrashCard};
